  ...
  const handleGestureCodeChange = (newCode: string) => {
    ...
    setDraft((prev) => {
      ...
      > = {
        ...
        'TOPEDGE+L': { nameKey: 'gesture.actions.leftDesktop.name', name: 'Switch Left Desktop', type: 2, builtinCmd: 25, descKey: 'gesture.actions.leftDesktop.desc', desc: 'Switch to left virtual desktop' },
        'TOPEDGE+R': { nameKey: 'gesture.actions.rightDesktop.name', name: 'Switch Right Desktop', type: 2, builtinCmd: 26, descKey: 'gesture.actions.rightDesktop.desc', desc: 'Switch to right virtual desktop' },
        ...
        'D-R-D': { nameKey: 'gesture.actions.screenshot.name', name: 'Quick Screenshot', type: 2, builtinCmd: 10, descKey: 'gesture.actions.screenshot.desc', desc: 'Launch EasyTools screenshot' },
      };
