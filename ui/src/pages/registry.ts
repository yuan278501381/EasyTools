...
export const PAGE_DEFINITIONS: PageDefinition[] = [
  ...
  { id: 'spotlight', titleKey: 'nav.spotlight', subtitleKey: 'navSubtitle.spotlight', category: 'core_tools', requiresPlugin: 'spotlight' },
  ...
  { id: 'remote_boost', titleKey: 'nav.remote_boost', subtitleKey: 'navSubtitle.remote_boost', category: 'core_tools', requiresPlugin: 'remote_boost' },
