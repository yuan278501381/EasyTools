...
- 🎨 **全新极客品牌视觉资产体系**：主程序与托盘图标全面重构为高定原画级流线型微标识，采用深空蓝超椭圆（Midnight Squircle）底座与大半径柔和悬浮光影，完美契合 Windows 11 Fluent 视觉语言；
