...
private:
    ...
    std::atomic<HWINEVENTHOOK> m_hookShow{nullptr};
    std::atomic<HWINEVENTHOOK> m_hookForeground{nullptr};
    std::atomic<HWINEVENTHOOK> m_hookLocation{nullptr};
    std::atomic<HWINEVENTHOOK> m_hookInvoke{nullptr};
